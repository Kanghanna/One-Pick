...
<body>
	<div id="all">
		...
		<%
			...
			try {
				String filePath = application.getRealPath("/WEB-INF/txt_file/2st_place_ranking.txt");
				...
				while (true) {
					...
					String src = application.getRealPath("/WEB-INF/image/연습생/" + arr[1] + ".jpg"); //사진 파일 경로
					String tag_file = application.getRealPath("/WEB-INF/image/logo/tag_ranking.png"); //1~10등까지 이미지
		...
		<%
			if (Integer.parseInt(arr[0]) % 2 == 0) {
				...
				if (Integer.parseInt(arr[0]) == 54) { //울림 김민서 일 때
