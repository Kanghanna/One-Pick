...
<body>
	<%
		String header = application.getRealPath("/WEB-INF/logo/op_header_bg.png"); ///WEB-INF/lib/
		String chd_menu1 = application.getRealPath("/WEB-INF/logo/child_menu_left.png");
		String chd_menu2 = application.getRealPath("/WEB-INF/logo/child_menu.png");
	%>
			...
			<div id="top_menu">
				<ul>
					...
					<ul id = "rank_chd">
						...
						<li><a href="rankingProc1.jsp">1주차</a></li>
						<li><a href="rankingProc2.jsp">2주차</a></li>
						<li><a href="rankingProc3.jsp">3주차</a></li>
					</ul>
					<li>
						<p>|</p> <a href="video.jsp">클립 영상</a>
					</li>
					<li>
